...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [[managedObject valueForKey:@"opportunityName"] description];
}
...
- (void)insertNewObject:(id)sender {
    ...
    [newManagedObject setValue:[NSDate date] forKey:@"opportunityName"];
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Opportunity" inManagedObjectContext:managedObjectContext];
    ...
    NSSortDescriptor *sortDescriptor1 = [[NSSortDescriptor alloc] initWithKey:@"hospital" ascending:NO];
    NSSortDescriptor *sortDescriptor2 = [[NSSortDescriptor alloc] initWithKey:@"opportunityName" ascending:NO];
    ...
    NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:managedObjectContext sectionNameKeyPath:@"hospital" cacheName:@"Root"];
